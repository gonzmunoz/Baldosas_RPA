    ...
    var dzTheme = function () {
        ...
        if (screenWidth < 991) {
            if ($('.mo-left .header-nav').children('div').length == 0) {
                ...
                jQuery('.mo-left .header-nav .logo-header > a > img').attr('src', 'http://www.iestrassierra.net/alumnado/curso1920/DAW/daw1920a11/Proyecto/Mammago/laravel/public/images/logo.png');
                jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src', 'http://www.iestrassierra.net/alumnado/curso1920/DAW/daw1920a11/Proyecto/Mammago/laravel/public/images/logo.png');
            }
        } else {
