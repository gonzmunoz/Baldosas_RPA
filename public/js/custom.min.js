var Autocare = function () {
    ...
    var e = $(window).width(), t = function () {
        ...
        $(".scroll").unbind().on("click", function (e) {
            if (e.preventDefault(), "" !== this.hash) {
                var t = this.hash, i = $(t).offset().top, n = parseInt($(".onepage").css("height"), 10);
        ...
        if (jQuery(".dzload").each(function () {
            ...
            if (0 == $(".mo-left .header-nav").children("div").length) {
                ...
                jQuery(".mo-left .header-nav").prepend(i), jQuery(".mo-left .header-nav .logo-header > a > img").attr("src", "http://www.iestrassierra.net/alumnado/curso1920/DAW/daw1920a11/Proyecto/Mammago/laravel/public/images/logo.png"), jQuery(".mo-left.lw .header-nav .logo-header > a > img").attr("src", "http://www.iestrassierra.net/alumnado/curso1920/DAW/daw1920a11/Proyecto/Mammago/laravel/public/images/logo.png")
            }
    ...
    return {
        init: function () {
            jQuery(".box-hover").on("mouseenter", function () {
            ...
            }(), o(), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), function (e) {
                ...
                setHeight: !1,
                axis: "y"
            }), l(), $(".item-close").on("click", function () {
                $(this).closest(".cart-item").hide("500")
            }), $(".cart-btn").unbind().on("click", function () {
                $(".cart-list").slideToggle("slow")
            }), $(".full-height").css("height", $(window).height()), c(), jQuery(window).on("resize", function () {
                jQuery(".modal:visible").each(s), jQuery(".equal-wraper").length && r(".equal-wraper .equal-col"), a()
